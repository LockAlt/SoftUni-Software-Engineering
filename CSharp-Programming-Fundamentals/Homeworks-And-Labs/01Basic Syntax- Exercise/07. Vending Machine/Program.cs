        ...
        static void Main(string[] args)
        {
           string command = Console.ReadLine();
            ...
            while (command!= "End")
            {
                ...
                {
                    case "Nuts":
                        totalPrice = 2.0;          //totalAccumulatedMoney -= 2.0;
                        break;
                    case "Water":
                        totalPrice = 0.7;
                        break;
                    ...
                    default:
                        ...
                        command = Console.ReadLine(); // Това го правим за да може ако е невалиден продукт няма как да имаме totalPrice следователно няма смисъл да преминава през проверките надолу
                        continue; // И това continue е за да се върне към началото на while цикъла с новата команда
